# /Users/robinsongarcia/projects/AzimutalEquidistant/projection/AzimutalEquidistant/transform.py
...
logger = logging.getLogger('AzimutalEquidistant_projection.AzimutalEquidistant.transform')

class AzimutalEquidistantTransformer(BaseCoordinateTransformer):
    """
    Transformation Logic for AzimutalEquidistant Projection.

    The `AzimutalEquidistantTransformer` class handles the conversion between geographic coordinates
    (latitude and longitude) and image coordinates on the AzimutalEquidistant projection plane.
    """

    def __init__(self, config):
        """
        Initialize the AzimutalEquidistantTransformer with the given configuration.

        Args:
            config: Configuration object containing necessary projection parameters.
        """
        logger.debug("Initializing AzimutalEquidistantTransformer.")
        required_attributes = [
            "lon_min",
            "lon_max",
            "lat_min",
        ...
        self.config = config
        logger.info("AzimutalEquidistantTransformer initialized successfully.")
    ...
    def spherical_to_image_coords(
        ...
        """
        logger.debug("Mapping spherical coordinates to image coordinates for AzimutalEquidistant projection.")
        H, W = shape  
    ...
    def projection_to_image_coords(
        ...
        """
        Convert AzimutalEquidistant planar coordinates (x, y) to image coordinates.
        ...
        Returns:
            Tuple[np.ndarray, np.ndarray]: Image coordinates map_x, map_y.
        """
        logger.debug("Mapping AzimutalEquidistant planar coordinates to image coordinates.")
