# /Users/robinsongarcia/projects/AzimutalEquidistant/projection/AzimutalEquidistant/grid.py
...
logger = logging.getLogger('AzimutalEquidistant_projection.AzimutalEquidistant.grid')

class AzimutalEquidistantGridGeneration(BaseGridGeneration):
    """
    Grid generation for the AzimutalEquidistant projection.
    """

    def projection_grid(self, delta_lat=0, delta_lon=0):
        """
        Generate the forward-projection grid (X, Y) for the AzimutalEquidistant projection.

        Returns:
            Tuple[np.ndarray, np.ndarray]: The X and Y coordinate grids for forward projection.
        """
        logger.debug("Generating AzimutalEquidistant projection grid.")
    ...
    def spherical_grid(self, delta_lat=0, delta_lon=0):
        ...
        """
        logger.debug("Generating AzimutalEquidistant spherical grid.")
